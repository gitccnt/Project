pipeline {
    ...
    stages {
        stage('Build') {
            steps {
                sh 'docker build -t "https://904277552529.dkr.ecr.eu-central-1.amazonaws.com/flaskapp:$GIT_COMMIT" .'
            }
        }
        stage('Push') {
            steps {
                ...
                sh 'docker push 904277552529.dkr.ecr.eu-central-1.amazonaws.com/flaskapp:latest'
            }
        }
        stage('Deploy') {
            steps {
